      ...
      <section className="w-full max-w-lg rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-lg shadow-slate-950/50">
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <input
            ...
            className="rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-base text-slate-100 transition outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/40"
